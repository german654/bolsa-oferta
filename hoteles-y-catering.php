...
<style type="text/css">
	#imgbanner{
		...
		background: url('img/bannercadaservicio/Amarillo/Catering.jpg');
		...
		<div class="row">
			<div class="col-12">
				<div class="bread-inner">
					...
					<!-- Bread Title -->
					<div class="bread-title"><h2 id="titulos">Hotel y Clubs.</h2> </div>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="blog-detail">
								...
								<div class="row outsourcing-valores">
									<div class="col-md-6">
										...
										<h5>Personal de Atención al Cliente</h5>
										<ul>
											<li>Recepcionistas/Telefonistas</li>
											<li>Cajeros</li>
											<li>Atención al cliente</li>
											<li>Bell-Boy/Valet Parking</li>
											<li>Vigilancia /Seguridad</li>
											<li>Enfermero</li>
										</ul>

										<h5>Personal de Banquetes</h5>
										<ul>
											<li>Camareros y Bartenders</li>
											<li>Chefs/Auxiliares de cocina/Pasteleros</li>
											<li>Montaje/Coordinador de montaje o manager</li>
										</ul>

									</div>
									<div class="col-md-6">

										<h5>Personal de Housekeeping</h5>
										<ul>
											<li>Ama de llaves</li>
											<li>Mucamas</li>
											<li>Esparcimiento</li>
											<li>Guardavidas</li>
											<li>Masajistas-instructores</li>
											<li>Baby-Sitters</li>
											<li>Recreación</li>
										</ul>
								...
								<div class="row blog-space">
									<div class="col-lg-6">
										<img src="img/img_cada_servicio/Catering_y_Hoteles.jpg" alt="#">
									</div>
									<div class="col-lg-6" style="text-align: justify;">
										...
										<p>Nos comprometemos a la mejora continua de la calidad y productividad, realizando una adecuación única y estratégica dentro del área de Housekeeping.</p>
