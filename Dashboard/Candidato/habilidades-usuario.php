...
<main id="main-container">
            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"
                        id="titulos" style="color: white;">Habilidades </h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content py-5 text-center">
        ...
        <a href="experiencia-laboral" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i
                    class="si si-action-undo fa-2x5"> </i> Retroceder</a>
        <a href="referencia-trabajo" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i
    ...
    <div style="margin-right:2%; margin-left:2%;">
        ...
        <div class="row gutters-tiny">
                ...
                <div class="block block-rounded block-themed">
                    ...
                    <div class="block-content block-content-full">
                        <div class="alert alert-primary text-justify indicaciones" role="alert">
                            ...
                            deberás añadir tus habilidadess tales como <b style="color:#0B3486;">idiomas , habilidades
                                personales , habilidades técnicas la cuál puedes añadir hasta 5 habilidades de cada
                                uno</b>.
                        </div>
                    </div>
                </div>
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12" id="pais">
                                ...
                                <select class="js-select2 form-control" id="example-select2" name="Idioma"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12" id="pais">
                                <!-- Select2 (.js-select2 class is initialized in Helpers.select2()) -->
                                <!-- For more info and examples you can check out https://github.com/select2/select2 -->
                                <select class="js-select2 form-control" id="example-select3" name="NivelEstudio"
                                        style="width: 100%;" data-placeholder="Selecciona una opción" required>
                                    <option></option>
                                    <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12" id="pais">
                                <!-- Select2 (.js-select2 class is initialized in Helpers.select2()) -->
                                <!-- For more info and examples you can check out https://github.com/select2/select2 -->
                                <select class="js-select2 form-control" id="example-select7" name="IDhabilidad"
                                        style="width: 100%;" data-placeholder="Selecciona una opción" required>
                                    <option></option>
                                    <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                    <?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12" id="pais">
                                <!-- Select2 (.js-select2 class is initialized in Helpers.select2()) -->
                                <!-- For more info and examples you can check out https://github.com/select2/select2 -->
                                <select class="js-select2 form-control" id="example-select8" name="NivelHabilidad"
                                        style="width: 100%;" data-placeholder="Selecciona una opción" required>
                                    <option></option>
                                    <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                    <option value="Básico">Básico</option>
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12" id="pais">
                                <!-- Select2 (.js-select2 class is initialized in Helpers.select2()) -->
                                <!-- For more info and examples you can check out https://github.com/select2/select2 -->
                                <select class="js-select2 form-control" id="example-select4" name="IDTecnica"
                                        style="width: 100%;" data-placeholder="Selecciona una opción" required>
                                    <option></option>
                                    <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                    <?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12" id="pais">
                                <!-- Select2 (.js-select2 class is initialized in Helpers.select2()) -->
                                <!-- For more info and examples you can check out https://github.com/select2/select2 -->
                                <select class="js-select2 form-control" id="example-select5" name="NivelTecnica"
                                        style="width: 100%;" data-placeholder="Selecciona una opción" required>
                                    <option></option>
                                    <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                    <option value="Básico">Básico</option>
            ...
            <div class="col-md-5">
                ...
                <div class="block block-rounded block-themed">
                    <div class="block-header bg-gd-primary">
                        <h3 class="block-title">Listas de Habilidades Personales
                            de <?php echo $PrimerNombre[0]; ?> </h3>
...
<!--                                         data-class="animated flipInY">-->
                                    ...
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: Deberas agregar tus
                                        habilidades ya sea en idiomas , habilidades personales por lo tanto son
                                        obligatorio para continuar el proceso y habilidades técnicas es opcional.
                                        <br><br>
                                        Solo se puede añadir 5 de cada de uno por lo tanto ya no podras agregar otro, Si
                                        desea agregar debera eliminar.
                                        <br><br>
                                        <b style="color: #0B3486;">Nota: Una vez agreado sus habilidades debera dar clic
                                            en boton siguiente para añadir sus referencias.</b>
                                    </p>
                        ...
                        <div class="pb-50">
                            <div class="row justify-content-center text-center">
                                <div class="col-md-10 col-lg-8">
                                    ...
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: Deberas agregar por
                                        lo <b>menos un idiomas y una habilida personal</b> ya que es requesito completar
                                        el formulario para para poder continuar con el proceso.
                                        <br><br>
                                        <b style="color: #0B3486;">Nota: Una vez agreado sus habilidades debera dar clic
                                            en boton siguiente para añadir sus referencias.</b>
                                    </p>
