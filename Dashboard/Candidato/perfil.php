...
<main id="main-container">
            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"
                        id="titulos" style="color: white;">Perfil usuario </h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="margin-right:2%; margin-left:2%;" data-toggle="appear" data-class="animated bounceInLeft">
        ...
        <?php if ($VerificaUsuarioSinPerfil == 1) { ?>
            <br>
            <div class="content py-5 text-center">
                <button class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5" disabled><i
                            class="si si-action-undo fa-2x5"> </i> Retroceder
                </button>
                <a href="educacion?notificar=1" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i
                            class="si si-action-redo fa-2x5"> </i> Siguiente</a>
            </div>
            <br>
        <?php } ?>
        ...
        <div class="row gutters-tiny">
                ...
                <form action="Modelos/ModelosPerfil/ActualizarPerfil.php" method="POST">
                    ...
                    <form action="Modelos/ModelosPerfil/NuevoPerfil.php" method="POST">
                        ...
                        <div class="block block-rounded block-themed">
                            ...
                            <div class="block-content block-content-full">
                                ...
                                <div class="alert alert-primary alert-dismissible fade show indicaciones text-justify"
                                     role="alert">
                                    <i class="fa fa-info-circle fa-2x5 text-dark"></i> Indicaciones : Los campos con
                                    asterisco (*) son obligatorios y deben ser completados para continuar con el proceso
                                    de registro.
                                ...
                                <div class="alert alert-primary alert-dismissible fade show indicaciones text-justify"
                                     role="alert">
                                    <i class="fa fa-info-circle fa-2x5 text-dark"></i> Crea tu perfil en la plataforma.
                                    Para ello<b style="color:#0B3486;"> deberá completar el formulario. </b> Luego
                                    tendrá que seguir <b style="color:#0B3486;"> ciertos pasos para terminar el
                                        proceso.</b> <b style="color: red;">Es requisito</b>.
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12" id="pais">
                                        ...
                                        <select class="js-select2 form-control" id="example-select2" name="OrigenPais"
                                                style="width: 100%;" data-placeholder="Selecciona una opción" required>
                                            <?php if ($resultPerfil == 1) { ?>
                                    ...
                                    <div class="col-12">
                                        <?php if ($resultPerfil == 1) { ?>
                                            ...
                                            <label class="css-control css-control-primary css-radio">
                                                <input type="radio" class="css-control-input" id="DepartamentoActivo"
                                                       value="<?php echo $IDDepartamento ?>" name="DepartamentoActivo"
                                                       checked>
                                                <span class="css-control-indicator"></span> Departamento activo
                                                en <?php echo $Departamento; ?>
                                            </label>
                                            <br>
                  ...
                  <span class="input-group-text">
                    <i class="si si-globe fa-2x5"></i>
                                                ...
                                                <input type="text" class="form-control" id="direccionExacta"
                                                       name="direccionExacta" maxlength="100"
                  ...
                  <span class="input-group-text">
                    <i class="si si-globe fa-2x5"></i>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <?php if ($resultPerfil == 1) { ?>
                                            <input type="number" class="form-control" name="edad" id="edad" min="18"
                                                   max="100" value="<?php echo $edad ?>" required>
                                        <?php } else { ?>
                                            <input type="number" class="form-control" name="edad" id="edad" min="18"
                                                   max="100" required placeholder="edad">
                                        <?php } ?>
            ...
            <span class="input-group-text">
              $
                                            ...
                                            <input type="number" name="salarioMinimo" min="0" class="form-control"
                                                   placeholder="rango del salario minimo"
                                                   value="<?php echo $salarioMinimo ?>">
            ...
            <span class="input-group-text">
              $
                                            ...
                                            <input type="number" name="salarioMaximo" min="0" class="form-control"
                                                   placeholder="rango del salario maximo"
                                                   value="<?php echo $salarioMaximo ?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text">.00</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <?php if ($resultPerfil == 1) {
                                            if ($genero == "F") {
                                                ?>
                                                <label class="css-control css-control-primary css-radio">
                                                    <input type="radio" class="css-control-input" value="F" id="genero"
                                                           name="genero" checked required>
                                                    <span class="css-control-indicator"></span> Femenino
                                                </label>
                                                <label class="css-control css-control-secondary css-radio">
                                                    <input type="radio" class="css-control-input" Value="M" id="genero"
                                ...
                                <div class="form-group row">
                                    <label class="col-12">Tipo de Currículo* <a href="#" data-toggle='modal'
                                                                                data-target='#exampleModal'
                                                                                class='js-tooltip-enabled'
                                                                                data-toggle='tooltip' title=''
                                                                                data-original-title='eliminar'>¿Qué
                                            significa esto?</a></label>
                                    <div class="col-12">
                                        <?php if ($resultPerfil == 1) {
                                            if ($confidencial == "Publico") {
                                                ?>
                                                <label class="css-control css-control-primary css-radio">
                                                    <input type="radio" class="css-control-input" id="confidencial"
                                                           value="Publico" name="confidencial" required checked>
                                                    <span class="css-control-indicator"></span> Publico
                                                </label>
                                                <label class="css-control css-control-secondary css-radio">
                                                    <input type="radio" class="css-control-input" id="confidencial"
                                                           value="Privado" name="confidencial" required>
                                                    <span class="css-control-indicator"></span> Privado
                                                </label>
                                            <?php } else { ?>
                                                <label class="css-control css-control-primary css-radio">
                                                    <input type="radio" class="css-control-input" id="confidencial"
                                                           value="Publico" name="confidencial" required>
                                                    <span class="css-control-indicator"></span> Publico
                                                </label>
                                                <label class="css-control css-control-secondary css-radio">
                                                    <input type="radio" class="css-control-input" id="confidencial"
                                                           value="Privado" name="confidencial" required checked>
                                                    <span class="css-control-indicator"></span> Privado
                                                </label>
                                                </label>
                                            <?php } ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <?php if ($resultPerfil == 1) { ?>
                                            <textarea class="form-control" id="js-ckeditor" name="DescriptionUser"
                                                      placeholder="Main Description" rows="8"
                                                      required><?php echo $Descripcion ?></textarea>
                                        <?php } else { ?>
                                            <textarea class="form-control" id="js-ckeditor" name="DescriptionUser"
                                                      placeholder="Main Description" rows="8" required></textarea>
                                        <?php } ?>
                ...
                <div class="block block-rounded block-themed">
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <?php if ($resultPerfil == 1) { ?>
                                    <input type="text" class="form-control" id="numidentificacion"
                                           name="numidentificacion" value="<?php echo $numidentificacion ?>"
                                           placeholder="N° identificación" pattern="[0-9]*" title="Solo números"
                                           required>
                                <?php } else { ?>
                                    <input type="text" class="form-control" id="numidentificacion"
                                           name="numidentificacion" placeholder="000000000" pattern="[0-9]*"
                            ...
                            <div class="col-12">
                                <?php if ($resultPerfil == 1) {
                                    if ($LicenciaConducir == "Si") {
                                        ?>
                                        <label class="css-control css-control-primary css-radio">
                                            <input type="radio" class="css-control-input" id="Licencia" value="Si"
                                                   name="Licencia" checked required>
                                            <span class="css-control-indicator"></span> Si
                                        </label>
                                        <label class="css-control css-control-secondary css-radio">
                                            <input type="radio" class="css-control-input" id="Licencia" Value="No"
                            ...
                            <div class="col-12">
                                <?php if ($resultPerfil == 1) {
                                    if ($Vehiculo == "Si") {
                                        ...
                                        <label class="css-control css-control-primary css-radio">
                                            <input type="radio" class="css-control-input" id="vehículo" value="Si"
                                                   name="vehículo" checked required>
                                            <span class="css-control-indicator"></span> Si
                                        </label>
                                        <label class="css-control css-control-secondary css-radio">
                                            <input type="radio" class="css-control-input" id="vehículo" value="No"
                                                   name="vehículo" required>
                                            <span class="css-control-indicator"></span> No
                                        </label>
                                    <?php } else { ?>
                                        <label class="css-control css-control-primary css-radio">
                        ...
                        <div class="form-group row">
                            <label class="col-12">El candidato posee conocimientos en manejar algún tipo
                                veihiculo*</label>
                            <div class="col-12">
                                <select class='form-control' id="Manejo" name="Manejo" required>
                                    ...
                                    <option value="vehículos para transporte de personas">vehículos para transporte de
                                        personas
                                    </option>
                        ...
                        <div class="form-group row">
                            <label class="col-12" for="ecom-product-meta-title">correo electrónico alternativo
                                /Opcional</label>
                            <div class="col-12">
                                <?php if ($resultPerfil == 1) { ?>
                                    <input type="text" class="form-control" id="Email" name="Email"
                                           value="<?php echo $CorreoAlternativo ?>" placeholder="email@ejemplo.com">
                                <?php } else { ?>
                                    <input type="text" class="form-control" id="Email" name="Email"
                            ...
                            <div class="col-12">
                                <?php if ($resultPerfil == 1) { ?>
                                    <input type="text" class="form-control" id="Celular" name="Celular"
                                           value="<?php echo $Celular ?>" required placeholder="+000 00000000"
                        ...
                        <div class="form-group row">
                            <label class="col-12" for="ecom-product-meta-title">Número telefónico + extensión
                                /Opcional</label>
                            <div class="col-12">
                                <?php if ($resultPerfil == 1) { ?>
                                    <input type="text" class="form-control" id="telefono" name="telefono"
                                           value="<?php echo $Telefono ?>" placeholder="+000 00000000"
                                           pattern="[\(]?[\+]?(\d{2}|\d{3})[\)]?[\s]?((\d{6}|\d{8})|(\d{3}[\*\.\-\s]){3}|(\d{2}[\*\.\-\s]){4}|(\d{4}[\*\.\-\s]){2})|\d{8}|\d{10}|\d{12}"
                                           title="+### ########">
                                <?php } else { ?>
                                    <input type="text" class="form-control" id="telefono" name="telefono"
                            ...
                            <div class="col-6" id="testForm">
                                <?php if ($resultPerfil == 1) {
                                    if ($Discapacitado == "Si") {
                                        ...
                                        <label class="css-control css-control-primary css-radio">
                                            <input type="radio" class="css-control-input" value="Si" id="Discapacidad"
                                                   name="Discapacidad" checked required>
                                            <span class="css-control-indicator"></span> Si
                                        </label>
                                        <label class="css-control css-control-secondary css-radio">
                                            <input type="radio" class="css-control-input" Value="No" id="Discapacidad2"
                                                   name="Discapacidad" required>
                                            <span class="css-control-indicator"></span> No
                                        </label>
                                    <?php } else { ?>
                            ...
                            <div class="col-6">
                                ...
                                <?php if ($resultPerfil == 1) {
                                    if ($ExperienciaLaboral == "Si") {
                                        ?>
                                        <label class="css-control css-control-primary css-radio">
                                            <input type="radio" class="css-control-input" value="Si"
                                                   id="ExperienciaUser" name="ExperienciaUser" checked required>
                                            <span class="css-control-indicator"></span> Si
                                        </label>
                                        <label class="css-control css-control-secondary css-radio">
                                            <input type="radio" class="css-control-input" Value="No"
                                                   id="ExperienciaUser" name="ExperienciaUser" required>
                                            <span class="css-control-indicator"></span> No
                                        </label>
                                    <?php } else { ?>
                                        <label class="css-control css-control-primary css-radio">
                                    ...
                                    <label class="css-control css-control-primary css-radio">
                                        <input type="radio" class="css-control-input" value="Si" id="ExperienciaUser"
                                               name="ExperienciaUser" required>
                                        <span class="css-control-indicator"></span> Si
                                    </label>
                                    <label class="css-control css-control-secondary css-radio">
                                        <input type="radio" class="css-control-input" Value="No" id="ExperienciaUser"
                                               name="ExperienciaUser" required>
                                        <span class="css-control-indicator"></span> No
                                    </label>
                                <?php } ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <select class="form-control" id="AreaExperiencia" name="AreaExperiencia"
                                        style="width: 100%;" data-placeholder="Selecciona una opción" required>
                                    <?php if ($resultPerfil == 1) { ?>
                                        <option selected
                                                value="<?php echo $IDAreaExperiencia ?>"><?php echo $NombreExperiencia ?></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                    <?php } else { ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <?php if ($resultPerfil == 1) { ?>
                                    <input type="text" class="form-control" id="Portafolio" name="Portafolio"
                                           value="<?php echo $Portafolio ?>" placeholder="http://portafolifio.com">
                                <?php } else { ?>
                                    <input type="text" class="form-control" id="Portafolio" name="Portafolio"
                                           placeholder="http://portafolifio.com">
                                <?php } ?>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <?php if ($resultPerfil == 1) {
                                    if ($Educacion == "Completa") {
                                        ?>
                                        <label class="css-control css-control-primary css-radio">
                                            <input type="radio" class="css-control-input" value="Completa"
                                                   id="Educacion" name="Educacion" checked required>
                                            <span class="css-control-indicator"></span> Completa
                                        </label>
                                        <label class="css-control css-control-secondary css-radio">
                                            <input type="radio" class="css-control-input" Value="Incompleta"
                                                   id="Educacion" name="Educacion" required>
                                    ...
                                    <label class="css-control css-control-primary css-radio">
                                        <input type="radio" class="css-control-input" value="Completa" id="Educacion"
                                               name="Educacion" required>
                                        <span class="css-control-indicator"></span> Completa
                                    </label>
                                    <label class="css-control css-control-secondary css-radio">
                                        <input type="radio" class="css-control-input" Value="Incompleta" id="Educacion"
                                               name="Educacion" required>
                                        <span class="css-control-indicator"></span> Incompleta
                                    </label>
                                <?php } ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Público: Cuando tu currículo sea consultado por una empresa esta podrá visualizar todos los datos del
                    mismo.</p>
                <br>
                <p>Privado: Cuando tu currículo sea consultado por una empresa no se podrá visualizar tu nombre y tu
                    actual lugar de trabajo.</p>
            </div>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="text-align: justify;">Sube un video a youtbe donde explique tus habilidades,pasatiempo,
                    etc</p>
...
<!--                                         data-class="animated flipInY">-->
                                    ...
                                    <P style="text-align: left;" data-toggle="appear" data-class="animated fadeInUp">
                                        Permitir a los reclutadores conocer más acerca de tu trayectoria, principios,
                                        habilidades y experiencia a través de tu perfil publicado. Tu perfil es tu carta
                                        de presentación y genera confianza en la iniciativa para ser reclutado. <br><br>
                                        Completa tu perfil ya que es <b style="color: red;">requisito</b> para tener
                                        acceso a la plataforma siguiendo estas instrucciones:
                                    </P>
                                    <ul style="text-align: left; " data-toggle="appear" data-class="animated fadeInUp">
                                        <li>1 – Llena los datos de tu perfil profesional. <b style="color: red;">(Obligatorio).</b>
                                        </li>
                                        <br>
                                        <li>2- Llena los datos de tus estudios académicos. “Diplomas, Estudios
                                            superiores, cursos, etc.” <b style="color: red;">(Obligatorio).</b>.
                                        </li>
                                        <br>
                                        <li>3– Llena los datos de tus experiencias laborales. “pasantías, horas
                                            sociales, voluntariado, etc.” <b style="color: red;">(Obligatorio).</b>.)
                                        </li>
                                        <br>
                                        <li>4– Agrega tus habilidades tales como idiomas, habilidades personales <b
                                                    style="color: red;">(Obligatorio)</b> y las habilidades técnicas es
                                            (Opcional).
                                        </li>
                                        <br>
                                        Adicionalmente puedes agregar, pero es opcional:<br><br>
                                        <li>5- Referencias de trabajos.</li>
                                        <br>
                                        <li>6- Anexar tu hoja de vida en PDF u otro tipo de documento.</li>
                                        <br>
                                    </ul>
