...
<main id="main-container">
            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"
                        id="titulos" style="color: white;">EDUCACIÓN ACADÉMICA </h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <br>
    <div class="content py-5 text-center">
        <a href="perfil?notificar=1" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i
                    class="si si-action-undo fa-2x5"> </i> Retroceder</a>
        <a href="experiencia?notificar=1" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i
    ...
    <div style="margin-right:2%; margin-left:2%;">
                ...
                <div class="block block-rounded block-themed">
                    <div class="block-header bg-gd-primary">
                        ...
                        <div class="block-options">
                            ...
                            <?php if (!$_GET['id'] == null) {
                                echo "<a href='educacion' class='btn btn-sm btn-alt-primary' style='margin-left: 5px; margin-right: 5px;'>Añadir nuevo</a>";
                            } ?>
              ...
              <i class='fa fa-save mr-5'></i>Guardar
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="alert alert-primary text-justify indicaciones" role="alert">
                            <i class="fa fa-info-circle fa-2x5 text-dark"></i> Indicaciones
                            : <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: En esta sección deberás añadir
                            tus estudios academicos para que los recluatadores sepan de tus estudios. <b
                                    style="color:#0B3486;">Puedes añadir hasta 5 estudios</b>
                        </div>
        ...
        Se han agregado 5 estudios por lo tanto ya no podrás añadir otro, Si desea agregar deberá eliminar o actualizar.
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" id="CentoEducativo" name="CentoEducativo"
                                       value="<?php echo $CentroEducativo; ?>" minlength="5" maxlength="100"
                                       title="Letras y números. Tamaño mínimo: 5. Tamaño máximo: 100" required
                                       placeholder="Digite el centro educativo o universidad">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12" id="testForm">
                                ...
                                <?php } else if (!$_GET['id'] == null && $IDCarrera == 92) { ?>
                                    ...
                                    <div class="form-group row"><label class="col-12" for="ecom-product-meta-title">Especialidad
                                            / Curso *</label>
                                        <div class="col-12"><input type="text" class="form-control" id="Especialidad"
                                                                   name="Especialidad"
                                                                   value="<?php echo $Especialidad; ?>" minlength="10"
                                                                   maxlength="100"
                                                                   title="Letras y números. Tamaño mínimo: 5. Tamaño máximo: 100"
                                                                   required placeholder="Máximo 100 palabras"></div>
                                    </div>

                                <?php } else { ?>

                                    <label class="col-12">Seleccione Universidad para elejir una carrera y especialidad
                                        para agregar tu bachillerato o diplomado*</label>

                                    <label class="css-control css-control-primary css-radio">
                                        <input type="radio" class="css-control-input" value="Si" id="especialidades"
                                    ...
                                    <label class="css-control css-control-secondary css-radio">
                                        <input type="radio" class="css-control-input" Value="No" id="especialidad"
                                               name="especialidad" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12" id="pais">
                                ...
                                <select class="js-select2 form-control" id="example-select3" name="IDPais"
          ...
          <span class="input-group-text">
            <i class="fa fa-calendar"></i>
                                    ...
                                    <input type="number" class="form-control" name="FechaInicio" placeholder="año"
              ...
              <i class='fa fa-save mr-5'></i> Guardar
                        ...
                        <?php if (!$_GET['id'] == null) {
                            echo "<a href='educacion' class='btn btn-block btn-alt-primary' style='margin-left: 5px; margin-right: 5px;'>Añadir nuevo</a>";
                        } ?>
...
<!--                                         data-class="animated flipInY">-->
                                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                        data-class="animated flipInY" id="titulos" style="color: #0B3486;">Estudios
                                        académicos </h3>
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: Deberás agregar los
                                        estudios académicos , cursos , estudios universitarios o algún tipo de
                                        especialidad.
                                        <br><br>
                                        Solo se puede añadir 5 estudios por lo tanto ya no podrás agregar otro, Si desea
                                        agregar deberá eliminar o actualizar.
                                        <br><br>
                                        <b style="color: #0B3486;">Nota: Una vez agreado sus estudios deberá dar clic en
                                            el botón siguiente para añadir sus experiencias laborales.</b>
                                    </p>
                ...
                <div class="block block-rounded block-transparent mb-0 bg-pattern"
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="pb-50">
                            <div class="row justify-content-center text-center">
                                <div class="col-md-10 col-lg-8">
                                    <img src="../../assets/img/icono/icono-advertencia.png" class="img-fluid"
                                         data-toggle="appear" data-class="animated flipInY" class="img-fluid"
                                         style="width: 100px; height: 100px;">
                                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                        data-class="animated flipInY" id="titulos" style="color: #0B3486;">no hay
                                        Estudios académicos </h3>
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: Deberás agregar por
                                        lo <b>menos un estudio académico</b> ya que es requesito completar el formulario
                                        para poder continuar con el proceso.
                                        <br><br>
                                        <b style="color: #0B3486;">Nota: Una vez agregado sus estudios deberá dar clic
                                            en el botón siguiente para añadir sus experiencias laborales.</b>
                                    </p>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#especialidades').on('click', function () {
            ...
            $("#resultEstudio").html('<div  class="form-group row"><label class="col-12" for="ecom-product-meta-title">Selecciona la facultad*</label><div class="col-12"><select class="form-control" name="Facultad1" id="Facultad1" ><option selected value="" disabled>Seleccione</option><?php while ($item = $stmt11->fetch()) {
                echo "<option value=" . $item['IDFacultates'] . ">" . $item['Nombre'] . "</option>";
            }?></select></div></div>');
