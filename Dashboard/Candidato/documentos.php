...
<?php if (isset($_GET['documentoError'])) {
    echo "<script>swal({title:'Advertenicia',text:'Debe anexar curriculum vitae. Recuerda poner el nombre del archivo curriculum vitae " . $PrimerNombre[0] . " " . $PrimerApellido[0] . " ',type:'warning'  });</script>";
} ?>
