...
<main id="main-container">
            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"
                        id="titulos" style="color: white;">Experiencia Laboral </h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content py-5 text-center">
        ...
        <a href="habilidades?notificar=1" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i
        ...
        <div class="row gutters-tiny">
                ...
                <i class='fa fa-save mr-5'></i>Guardar
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="alert alert-primary text-justify indicaciones" role="alert">
                            ...
                            deberás agregar tus experiencias laborales como prácticas profesionales , horas sociales o
                            algún puesto de trabajo para que así los recluatadores sepan las experiencias. <b
           ...
           Se agreado 5 experiencias laborales por lo tanto ya no podrás agregar otro, Si desea agregar deberá eliminar o actualizar. 
                        ...
                        <div class="form-group row">
                            <label class="col-12" for="ecom-product-meta-title">Cargo ejercido o Puesto de trabajo
                                *</label>
                            <div class="col-12">
                                <input type="text" class="form-control" id="Puesto" name="Puesto"
                                       value="<?php echo $Cargo ?>" placeholder="digite el cargo del trabajo" Required>
                            </div>
                        </div>
                        ...
                        <div id="area" class="form-group row">
                            ...
                            <div class="col-12" id="pais">
                                ...
                                <select class="js-select2 form-control" id="AreaCategoria" name="AreaCategoria"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12" id="pais">
                                <!-- Select2 (.js-select2 class is initialized in Helpers.select2()) -->
                                <!-- For more info and examples you can check out https://github.com/select2/select2 -->
                                <select class="js-select2 form-control" id="example-select3" name="SectorEmpresa"
                                        style="width: 100%;" data-placeholder="Selecciona una opción" Required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" id="Empresa" name="Empresa"
                                       value="<?php echo $Empresa ?>" placeholder="digite el nombre de la empresa">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" name="webempresa" class="form-control"
                                       value="<?php echo $webempresa ?>" placeholder="https://www.tuempresa.com">
                            </div>
                        </div>
            ...
            <span class="input-group-text">
              <i class="fa fa-calendar"></i>
                                    ...
                                    <input type="number" name="FechaInicio" class="form-control" min="1000"
                                           value="<?php echo $FechaInico ?>" Required placeholder="Año">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="js-ckeditor" name="Descrip"
...
<!--                                         data-class="animated flipInY">-->
                                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                        data-class="animated flipInY" id="titulos" style="color: #0B3486;">experiencias
                                        laborales</h3>
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: Deberás agregar tus
                                        <b style="color: red;">experiencias</b> laborales ya sea en tu área , práctias
                                        profesionales , horas sociales o algún tipo <b
                                                style="color: red;">experiencias</b> laborales
                                        <br><br>
                                        Solo se puede añadir 5 <b style="color: red;">experiencias</b> laborales por lo
                                        tanto ya no podrás agregar otro, Si desea agregar deberá eliminar o actualizar.
                                        <br><br>
                                        <b style="color: #0B3486;">Nota: </b> Una vez agreado sus <b
                                                style="color: red;">experiencias</b> laborales deberá dar clic en botón
                                        siguiente para añadir sus habilidades.
                                    </p>
                ...
                <div class="block block-rounded block-transparent mb-0 bg-pattern"
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="pb-50">
                            <div class="row justify-content-center text-center">
                                <div class="col-md-10 col-lg-8">
                                    <img src="../../assets/img/icono/icono-advertencia.png" class="img-fluid" s
                                    ...
                                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                        ...
                                        Expereincias laborales</h3>
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: Deberás agregar por
                                        lo <b>menos una experiencias</b> ya que es requesito completar el formulario
                                        para poder continuar con el proceso. Ya sea de tu área , horas sociales ,
                                        voluntariados, prácticas profesionales o alguna experiencia.
                                        <br><br>
                                        <b style="color: #0B3486;">Nota: Una vez agreado sus estudios deberá dar clic en
                                            el botón siguiente para añadir sus habilidades.</b>
                                    </p>
