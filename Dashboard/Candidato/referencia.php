...
<main id="main-container">
            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"
                        id="titulos" style="color: white;">Referencias </h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="margin-right:2%; margin-left:2%;">
        ...
        <div class="content py-5 text-center">
            ...
            <a href="documentos?notificar=1" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i
        ...
        <div class="row gutters-tiny">
                ...
                <div class="block block-rounded block-themed">
                    <div class="block-header bg-gd-primary">
                        <div class="block-options">
                            ...
                            <?php if (!$_GET['id'] == null) {
                                echo "<a href='referencia' class='btn btn-sm btn-alt-primary' style='margin-left: 5px; margin-right: 5px;'>Añadir Nuevo</a>";
                            } ?>
              ...
              <i class='fa fa-save mr-5'></i>Guardar
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="alert alert-primary text-justify indicaciones" role="alert">
                            ...
                            tus <b style="color:#0B3486;"> referencias de trabajos es opcional. </b>
                        </div>
          ...
          Se agreado 3 referencia por lo tanto ya no podras agregar otro, Si desea agregar debera eliminar o actualizar.
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" id="nombre" name="nombre"
                                       value="<?php echo $Encargado ?>" required
                                       placeholder="Digite el nombre de la persna">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" id="cargo" name="cargo"
                                       value="<?php echo $Cargo ?>" placeholder="Digite el cargo">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-12" for="ecom-product-meta-title">Correo Electrónico de la persona |
                                Opcional</label>
                            <div class="col-12">
                                <input type="text" class="form-control" id="email" name="email"
                                       placeholder="email@ejemplo.com" value="<?php echo $Correo ?>">
                            </div>
                        </div>
              ...
              <i class='fa fa-save mr-5'></i>Guardar
                        ...
                        <?php if (!$_GET['id'] == null) {
                            echo "<a href='referencia' class='btn btn-block btn-alt-primary' style='margin-left: 5px; margin-right: 5px;'>Añadir Nuevo</a>";
                        } ?>
                            ...
                            <div class="row justify-content-center text-center">
                                <div class="col-md-10 col-lg-8">
                                    ...
                                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                        data-class="animated flipInY" id="titulos" style="color: #0B3486;">Referencias
                                        de trabajos / Opcional </h3>
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        ...
                                        referencias laborales ya sea en tu área , prácticas profesionales , horas
                                        sociales o algún tipo experiencias laborales. Este apartado es opcional.
                                        <br><br>
                                        Solo puede añadir 3 referencias por lo tanto ya no podrás agregar otra, Si desea
                                        agregar deberá eliminar o actualizar.
                                        <br><br>
                                        <b style="color: #0B3486;">Nota: Una vez agregado sus referencias debera dar
                                            clic en el botón siguiente para anexar su curriculum vitae.</b>
                                    </p>
