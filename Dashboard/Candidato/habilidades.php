...
<!--                                         data-class="animated flipInY">-->
                                    ...
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        ...
                                        habilidades ya sea en idiomas , habilidades personales por lo tanto son <b
                                                style="color: red;">OBLIGATORIAS</b> para continuar el proceso y
                                        habilidades técnicas es opcional.
                                        <br><br>
                                        Solo se puede añadir 5 de cada de uno por lo tanto ya no podrás agregar otro, Si
                                        desea agregar deberá eliminar.
                                        <br><br>
                                        <b style="color: #0B3486;">Nota: Una vez agreado sus habilidades deberá dar clic
                                            en el botón siguiente para añadir sus referencias.</b>
                                    </p>
                                ...
                                <div class="col-md-10 col-lg-8">
                                    ...
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        ...
                                        lo <b>menos un idioma y una habilidad personal</b> ya que es requesito completar
                                        el formulario para poder continuar con el proceso.
                                        <br><br>
                                        <b style="color: #0B3486;">Nota: Una vez agreado sus habilidades deberá dar clic
                                            en el botón siguiente para añadir sus referencias.</b>
                                    </p>
