...
<!--                                             data-class="animated flipInY">-->
                                        <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                            data-class="animated flipInY"
                                            id="titulos" style="color: #0B3486;">Bienvenido al chat <br>BOLSA LABORAL!
                                        </h3>
                                        <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                           data-class="animated fadeInUp">
                                            ...
                                            de información que esté
                                            relacionada con tus datos personales no será compartida ni publicada en esta
                                            plataforma. Recuerda
                                            respestar a los reclutadores.
                                            <br><br>
                                            <b style="color: #0B3486; text-align: center;">Nota: Una vez fuera del chat
                                                ya no podra enviar
                                                mensaje solo ver los mensaje hasta que reclutador te contacte de nuevo
                                                podras hacerlo.</b>
                                        </p>
            ...
            <div class="col-12 col-md-12 col-xl-5">
                ...
                <div class="js-chat-form block-content block-content-full block-content-sm bg-body-light">
                    ...
                    <?php } else { ?>
                        ...
                        <br>
                    <?php } ?>
                    <textarea class="form-control" id="js-ckeditor" class="mensaje" placeholder="Main Description"
                              rows="12"
                              required></textarea>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $.ajax({
            ...
            dataType: 'html',
            data: {
                Receptor: "<?php echo $usuarioEmpresa; ?>",
                Usuario: "<?php echo $IDUser ?>",
                empresa: "<?php echo $resultEmpresa; ?>"
            },
            beforeSend: function () {
