...
<!--            <img src="../../assets/recusosMundoEmpleo/logo.png" style="width: 150px; height:60px;">-->
            ...
            <P style="color: black; font-size: 8px;">
                ...
                E-mail alternativo <br><a
                        href="mailto:<?php echo $CorreoAlternativo ?>"><?php echo $CorreoAlternativo ?></a><br>
        ...
        <div class="col-sm">
            ...
            <h2 style="color: black; margin-top: -100px; margin-left: 375px; text-align: left; position: absolute;">
                <?php if ($confidencial == "Privado") { ?>
                    N/D
                <?php } else { ?>
                    <?php echo $Nombres . "<br> " . $Apellidos;
                } ?></h2>
            <p style="color: #3f9ce8; margin-top: -25px; font-size: 14px;  margin-left: 375px; position: absolute;"><?php echo $Disponibilidad ?></p>
            <br><br>
