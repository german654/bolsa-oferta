...
<main id="main-container">
            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"
                        id="titulos" style="color: white;">Búsqueda De Candidatos </h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content py-5 text-center">
        ...
        <a href="javascript:void(0)" class="btn  btn-rounded btn-noborder btn-alt-primary mr-5 mb-5" data-toggle="modal"
           data-target="#modal-terms2"> <i class="si si-magnifier fa-2x5"> </i> Utilizar Filtros</a>

        <a href="candidatos-vistos" class="btn  btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i
                    class="fa fa-user"> </i> Perfiles vistos</a>

        <a href="javascript:void(0)" class="btn  btn-rounded btn-noborder btn-alt-primary mr-5 mb-5" data-toggle="modal"
           data-target="#modal-terms3"> <i class="fa fa-exclamation-triangle fa-2x5"></i> </i> Instrucciones</a>
        ...
        <div class="col-lg-12">
            ...
            <div class="alert alert-secondary text-left" role="alert"
                 style="border-left: solid 5px; border-color: #FCC201; ">
                <i class="fa fa-info-circle fa-2x5"></i> Indicaciones : Para realizar una busqueda debera digitar un
                cargo en el campo y la frase digitada apareceran los candidatos.<br>
    ...
    <!-- Terms Modal -->
    <div class="modal fade" id="modal-terms3" tabindex="-1" role="dialog" aria-labelledby="modal-terms3"
         aria-hidden="true">
...
<!--                                         data-class="animated flipInY">-->
                                <h3 class="font-size-h2 font-w300 mt-20 text-center" data-toggle="appear"
                                ...
                                <p>3 Cada vez que seleccione o presione a un candidato de la fila cambiará a un color y
                                    luego en el nombre del candidato cambiará a color verde que significa que es un
                                    candidato visto.</p>
                                <p>4 Si desea ver el perfil del candidato presione el nombre del candidato o el botón
                                    donde lo dirige al perfil.</p>
                                <p>5 Al revisar un perfil habrá un historial de los candidatos vistos. Solo apareceran
                                    durante 15 días.</p>
                                <p>6 Puede utilizar los filtros personalizados.</p>
                                <p>7 Cada vez que realice una busqueda, perfil visto o seguimiento se le genera un
                                    reporte general.</p>
                                <p>8 Se le genera un reporte cada vez que descarga un curriculum vitae o envia a un
                ...
                <div class="block-content">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <select class='form-control' name="TipoVehiculo" id="TipoVehiculo">
                                        ...
                                        <option value="vehículos para transporte de personas">vehículos para transporte
                                            de personas
                                        </option>
                                ...
                                <div class="col-sm">
                                    ...
                                    <input type="number" name="edadmenor" id="edadmenor" min="18" max="100"
                                           placeholder="Rango Menor edad" class="form-control"><br>
                                    <input type="number" name="edadmayor" id="edadmayor" min="18" max="100"
                                           placeholder="Rango Mayor edad" class="form-control"><br>
                  ...
                  <span class="input-group-text">
                    $
                                        ...
                                        <input type="number" name="salariomenor" id="salariomenor" min="1"
                                               placeholder="Menor" class="form-control">
                  ...
                  <span class="input-group-text">
                    $
                                        ...
                                        <input type="number" name="salariomayor" id="salariomayor" min="1"
                                               placeholder="Mayor" class="form-control">
                                        <div class="input-group-append">
                                            <span class="input-group-text">.00</span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm">
                                    ...
                                    <div id="pais">
                                        ...
                                        <select class="js-select2 form-control pais" id="example-select2"
                                                name="OrigenPais" style="width: 100%;"
                                ...
                                <div class="col-sm">
                                    ...
                                    <select class='form-control' name="ExperiencaProfessional"
                                            id="ExperiencaProfessional">
                                        <option selected value="" disabled>Seleccione</option>
                                        <option value="Si">Si</option>
                                        <option value="No">No</option>
                                        <option value="Indiferente">Indiferente</option>
                                    ...
                                    <select class="form-control" id="AreaExperiencia" name="AreaExperiencia"
                                            style="width: 100%;" data-placeholder="Selecciona una opción">
                                        <option selected disabled value="">Seleccione</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <select class='form-control' name="NivelEstudio" id="NivelEstudio1">
                                        ...
                                        <option value="Master/Magister/Maestría Completa">Master/Magister/Maestría
                                            Completa
                                        </option>
                                        <option value="Estudiante de Master/Magister/Maestría">Estudiante de
                                            Master/Magister/Maestría
                                        </option>
                                        <option value="Master/Magister/Maestría Incompleta">Master/Magister/Maestría
                                            Incompleta
                                        </option>
                                        ...
                                        <option value="Estudiante de Post-Grado">Estudiante de Post-Grado</option>
                                        <option value="Universidad Completa/Graduado">Universidad Completa/Graduado
                                        </option>
                                        ...
                                        <option value="Estudios Inferiores Completo">Estudios Inferiores Completo
                                        </option>
                                        <option value="Estudios Inferiores Incompleto">Estudios Inferiores Incompleto
                                        </option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="activarDosEstudios"
                                               id="activarDosEstudios">
                                    ...
                                    <input type="text" name="especialidad" id="especialidad" class="form-control"
                                           placeholder="una palabra clave" disabled>

                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="activarEspeciliadad"
                                               id="activarEspeciliadad">
                                        <label class="form-check-label" for="defaultCheck2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div id="areaempresa2">
                                        <label>Áreas laborales</label>
                                        <select class="form-control" id="example-select4AreaEmpresa" name="areaempresa"
                                                disabled>
                                            <option selected value='' disabled>Seleccione</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="HabilitarExpiriencia2"
                                               id="HabilitarExpiriencia">
                                        <label class="form-check-label" for="defaultCheck2">
                                    ...
                                    <input type="text" name="cargoEjercido" id="cargoEjercido" class="form-control"
                                           placeholder="Una Palabra clave" disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="HabilitarDosIdiomas"
                                               id="habilitarIdioma" style="margin-left: 5px;">
        ...
        tablaUsuarios = $('#tablaUsuarios').DataTable({
            ...
            "ajax": {
                ...
                "data": {
                    ...
                    yearsExpiriencia: yearsExpiriencia,
                    disponibilidad: disponibilidad,
                    SituacionActual: SituacionActual,
                    foto: foto,
                    edadmenor: edadmenor,
                    edadmayor: edadmayor,
                    salarioMenor: salarioMenor,
                    salarioMayor: salarioMayor,
                    idioma1: idioma1,
                    ...
                    NivelEstudio1: NivelEstudio1,
                    carrera1: carrera1,
                    PaisDelEstudio: PaisDelEstudio,
                    NivelEstudio2: NivelEstudio2,
                    carrera2: carrera2,
                    PaisDelEstudio2: PaisDelEstudio2,
                    estudioespecialidad: estudioespecialidad,
                    evaluarAreaLaboral1: evaluarAreaLaboral1,
                    evaluarAreaLaboral2: evaluarAreaLaboral2
...
//Buscar la  area por escrito
        ...
        if (evaluaredadmenor > evaluaredadmayor) {
            swal({
                title: 'alerta',
                text: 'El rango de la edad  mayor debe ser mayor al rango de la edad menor',
                type: 'error'
            });
        }
        ...
        if (evaluaredadmayor < evaluaredadmenor) {
            swal({
                title: 'alerta',
                text: 'El rango de la edad  menor debe ser mayor al rango de la edad mayor',
                type: 'error'
            });
        }
        ...
        if (evaluarsalariomenor > evaluarsalariomayor) {
            swal({
                title: 'alerta',
                text: 'El rango del salario  mayor debe ser mayor al rango del salario menor',
                type: 'error'
            });
        }
        ...
        if (evaluarsalariomayor < evaluarsalariomenor) {
            swal({
                title: 'alerta',
                text: 'El rango del salario  menor debe ser mayor al rango del salario mayor',
                type: 'error'
            });
        }
