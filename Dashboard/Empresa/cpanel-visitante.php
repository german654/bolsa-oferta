            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    ...
                    <h2 class="h4 font-w400  invisible" id="titulos" style="color: white;" data-toggle="appear"
                        data-class="animated fadeInUp">¡Bienvenido a tu panel <?php echo $PrimerNombre[0] ?> ! </h2>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <p class="text-center">
                                    <a class="img-link" href="javascript:void(0)" data-toggle="modal"
                                       data-target="#modal-terms">
                                        <img class="img-avatar img-avatar-thumb" style="width: 135px; height: 135px;"
                                ...
                                <div class="block-content text-center">
                                    <div class="row items-push">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <button class="btn btn-hero btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"
                                                        disabled><i class="fa fa-user"></i> Cuenta Usuario
                                                </button>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <br>
                                            <button class="btn btn-hero btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"
                                                    disabled><i class="fa fa-cloud-upload"></i> Logo Empresa
                                            </button>
                        ...
                        <div class="block block-transparent  d-flex align-items-center w-100" class="cuadros">
                            <div class="block-content block-content-full" style="margin-bottom: 13px;">
                                ...
                                <div class="py-15 px-20 clearfix border-black-op-b">
                                    ...
                                    <div class="font-size-sm font-w600 text-uppercase text-white">Estado de la empresa
                                    </div>
                                    <hr>
...
<!--                                 data-class="animated flipInY">-->
                            <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"
                                id="titulos" style="color: #0B3486;">sube tu logo de empresa </h3>
                            ...
                            <div class="row justify-content-center text-center">
                                <div class="col-md-10 col-lg-8">
                                    ...
                                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                        data-class="animated flipInY" id="titulos" style="color: #0B3486;">Periodo
                                        Finalizado </h3>

                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: hemos desactivado tu
                                        usuario debido que ha terminado periodo. Recuerda Al finalizar
                                        fecha <?php $date = date_create($FechaVencimiento);
                                        echo date_format($date, "d/m/Y"); ?>. Ya no podra utilizar la plataforma por que
                                        deberas solicitar el servicio de nuevo con BOLSA LABORAL.
                                    </p>
