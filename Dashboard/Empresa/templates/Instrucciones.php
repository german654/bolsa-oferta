...
<!--                                         data-class="animated flipInY">-->
                                    ...
                                    <p class="text-muted" style="text-align: justify;" data-toggle="appear"
                                       data-class="animated fadeInUp">
                                        <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: Hemos terminado de
                                        configurar tu perfil de empresa. Recuerda al finalizar la
                                        fecha <?php $date = date_create($FechaVencimiento);
                                        echo date_format($date, "d/m/Y"); ?>. Ya no podrá utilizar la plataforma por que
                                        deberás solicitar el servicio de BOLSA LABORAL Centroamérica.
                                    </p>
                        ...
                        <div class="slick-slide pb-50">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-8">
                                    ...
                                    <h3 class="font-size-h2 " data-toggle="appear" data-class="animated flipInY"
                                        id="titulos" style="color: #0B3486;">Novedades</h3>
...
<!--                                         data-class="animated flipInY">-->
                                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                        data-class="animated flipInY" id="titulos" style="color: #0B3486;">sube tu logo
                                        de empresa </h3>
                                    <p>Nota:El logo debe contener las dimensiones de 100 x 100</p>

                                    <br>
                                    <form method="POST" action="Modelos/ModelosImagenes/CambiarImagenEmpresa1vez.php"
                                          enctype="multipart/form-data">
                                        <input type="hidden" name="IDempresa" value="<?php echo $IDEmpresa; ?>">
                                        <input type="hidden" name="imgempresa" value="<?php echo $logo; ?>">
                                        <input type="file" name="imgusu" id="imgusu" class="form-control"
                            ...
                            <p class="text-center">
                                ...
                                <button type='submit' class='btn btn-sm btn-hero btn-noborder mb-10 mx-5' name='Guardar'
                                        id="valida2r" style="background:#FCC201; color:#0B3486; font-weight: bold;">
                                    <i class='fa fa-save mr-5'></i>Guardar
                                </button>

                                <a href="?success=1" class="btn btn-sm btn-hero btn-noborder  mb-10 mx-5"
                                   style="background:#FCC201; color:#0B3486; font-weight: bold;"> luego <i
                                            class="fa fa-arrow-right ml-5"></i> </a>
