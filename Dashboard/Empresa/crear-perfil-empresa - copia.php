        ...
        <div class="bg-primary-dark-op">
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    <center><img src="../../assets/img/logo/logo2_footer.png" data-toggle="appear"
                                 data-class="animated bounceInDown"></center>
                    <h1 class="font-w700 text-white mb-10 invisible" data-toggle="appear"
                        data-class="animated fadeInUp">BOLSA LABORAL</h1>
                    <h2 class="h4 font-w400 text-white-op invisible" data-toggle="appear"
                        data-class="animated fadeInUp">Crear Perfil empresa</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-7">
                ...
                <div class="block block-rounded block-themed">
                    ...
                    <div class="block-content block-content-full">
                        <p> <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?> Cualquier tipo de información que
                            esté relacionada con tus datos personales no será compartida ni publicada en esta
                            plataforma.Tus datos personales solo seran mostradas con los reclutadores que desean aplicar
                            a una oferta de trabajo y saber de que trata la empresa.</p>

                        <p>IMPORTANTE: Los campos con asterisco (*) son obligatorios y deben ser completados para
                            continuar con el proceso de registro.</p>


                        <div class="form-group row">
                            <label class="col-12" for="example-select4">Actividad de la empresa
                        ...
                        <div class="form-group row">
                            <label class="col-12" for="example-select2">Seleccione su pais de
                                ...
                                <?php if ($resultPerfil == 1) { ?>
                                    ...
                                    <label class="css-control css-control-primary css-radio">
                                        <input type="radio" class="css-control-input" id="DepartamentoActivo"
                                               value="<?php echo $IDDepartamento ?>" name="DepartamentoActivo" checked>
                            ...
                            <div class="col-8">
                                <?php if ($resultPerfil == 1) { ?>
                                    <input type="text" class="form-control" name="nombreempresa" id="nombreempresa"
                                           value="<?php echo $FechaNaciento ?>" required>
                                <?php } else { ?>
                                    <input type="text" class="form-control" name="nombreempresa" id="nombreempresa"
                                           required placeholder="Por favor, ingrese el nombre de la empresa">
                                <?php } ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <?php if ($resultPerfil == 1) { ?>
                                    <input type="text" class="form-control" name="ubicacionEmpresa"
                                           id="ubicacionEmpresa" value="<?php echo $FechaNaciento ?>" required>
                                <?php } else { ?>
                                    <input type="text" class="form-control" name="ubicacionEmpresa"
                                           id="ubicacionEmpresa" required
                                           placeholder="Por favor, ingrese la ubicación de la empresa">
                                <?php } ?>
                        ...
                        <div class="form-group row">
                            <label class="col-4">Ubicación por medio de mapa opcional. <a href="#">Haz clic para más
                                    información</a></label>
                            <div class="col-8">
                                <?php if ($resultPerfil == 1) { ?>
                                    <input type="text" class="form-control" name="mapaempresa" id="mapaempresa"
                                           value="<?php echo $FechaNaciento ?>" required>
                                <?php } else { ?>
                                    <input type="text" class="form-control" name="mapaempresa" id="mapaempresa"
                                           placeholder="Por favor, ingrese la ubicación  por medio de mapa">
                                <?php } ?>
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                ...
                                <?php } else { ?>
                                    <input type="text" class="form-control" name="emailEmpresa" id="emailEmpresa"
                                           required placeholder="Por favor, ingrese E-mail de la empresa">
                                <?php } ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                ...
                                <?php } else { ?>
                                    <input type="text" class="form-control" name="codigopostal" id="codigopostal"
                                           required placeholder="Por favor, ingrese el codigo postal">
                                <?php } ?>
                        ...
                        <div class="form-group row" style="margin-left: 2px;">
                            ...
                            <br>
                            <label class="col-12">Solo deberas poner el nombre de tu fanpage de cada uno. <b>SOLO EL
                                    NOMBRE</b></label>
                            <br>
                            ...
                            <div class="col-6">
                                <?php if ($resultPerfil == 1) {
                                    if ($Vehiculo == "Si") {
                                        ...
                                        <label class="css-control css-control-primary css-radio">
                                            <input type="radio" class="css-control-input" id="confidencial" value="Si"
                                                   name="confidencial" checked required>
                                            <span class="css-control-indicator"></span> Si
                                        </label>
                                        <label class="css-control css-control-secondary css-radio">
                                            <input type="radio" class="css-control-input" id="confidencial" value="No"
