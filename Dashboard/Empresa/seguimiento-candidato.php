...
<main id="main-container">
            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"
                        id="titulos" style="color: white;">Seguimiento De Candidatos </h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="margin-right:2%; margin-left:2%;">
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="block">
                            <div class="block-content">
                                ...
                                <p> <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?> Cualquier tipo de
                                    información que esté relacionada al candidato no será compartida al usuario ni
                                    publicada en esta plataforma. En la tabla quedara registrado el seguimiento del
                                    candidato.</p>
                                ...
                                <div class="block block-themed text-center">
                                    <div class="block-content block-content-full block-sticky-options pt-30 bg-primary-dark">
                                        ...
                                        <img class="img-avatar img-avatar-thumb"
                                             src="../../assets/img/user/<?php echo $Foto ?>" alt=""
                ...
                <div class="block block-rounded block-themed">
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="row gutters-tiny invisible" data-toggle="appear" data-class="animated bounceInLeft">
                            ...
                            <div class="col-md-4">
                                <a class=" text-center" href="javascript:void(0)" data-toggle="modal"
                                   data-target="#modal-terms3">
                            ...
                            <div class="col-md-6">
                                <a class=" text-center"
                                   href="chat?chats=<?php echo base64_encode($_SESSION['iduser']); ?>&estado=<?php echo base64_encode('Notificar'); ?>&usuario=<?php echo $_GET['id'] ?>&email=<?php echo $Email ?>">
                                    <div class="block-content ribbon ribbon-bookmark ribbon-crystal  cuadros">
                                        <p class="mt-5">
        ...
        <!-- Terms Modal -->
        <div class="modal fade" id="modal-terms5" tabindex="-1" role="dialog" aria-labelledby="modal-terms"
             aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <div class="block">
                                <div class="block-content block-content-full">
                                    <form action="Modelos/ModelosSeguimientos/Eliminar-historial-seguimiento.php"
                                          method="POST">
                                        <p>Seguro que desea eliminar el seguimiento
                                            de <?php if ($confidencial == "Privado") { ?>
                                                <b>N/D</b>
                                            <?php } else { ?>
                                                <b><?php echo $Nombres . " " . $Apellidos; ?></b>
                                            <?php } ?></p>
                                        <input type="hidden" name="iduserhistorial" value="<?php echo $_GET['id'] ?>">
                                        <input type="hidden" name="idempresaHistorial"
                            ...
                            <div class="modal-footer">
                                <button type='submit' class='btn btn-alt-danger' name='EliminarSeguimiento'
                                        id="EliminarSeguimiento">
        ...
        <!-- Terms Modal -->
        <div class="modal fade" id="modal-terms3" tabindex="-1" role="dialog" aria-labelledby="modal-terms"
             aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-slidedown" role="document">
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                            ...
                            <div class="block">
                                <div class="block-content block-content-full">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" name="Asunto" id="Asunto" required
                                                   placeholder="Por favor,ingrese el asunto">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <textarea id="js-ckeditor2" name="Comentario" id="Comentario"
                                                      placeholder="escribe tu comentario" rows="8" required></textarea>
        ...
        <!-- Terms Modal -->
        <div class="modal fade" id="modal-terms4" tabindex="-1" role="dialog" aria-labelledby="modal-terms"
             aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-slidedown" role="document">
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <div class="block">
                                <div class="block-content block-content-full">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-12" for="example-select2">Seleccione el tipo
                                            seguimiento*</label>
                                        <div class="col-12">
                                            <!-- Select2 (.js-select2 class is initialized in Helpers.select2()) -->
                                            <!-- For more info and examples you can check out https://github.com/select2/select2 -->
                                            <select class="form-control" id="opcionSeguimiento" name="opcionSeguimiento"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-12">Comentario*</label>
                                        <div class="col-12">
                                            <textarea class="form-control" id="js-ckeditor" id="comentarioSeguimiento"
                                                      name="comentarioSeguimiento" placeholder="Main Description"
...
<!--                                         data-class="animated flipInY">-->
                                    <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear"
                                        data-class="animated flipInY" id="titulos" style="color: #0B3486;">Has agreado
                                        el Seguimiento de <br> <?php echo $_GET['user']; ?> </h3>
    ...
    $('#Confirmar').on('click', function () {
        ...
        $.ajax({
            ...
            data: {
                ...
                seguimiento: evaluartipoSeguimiento,
                comentario: mensaje
            },
            beforeSend: function () {
                swal({
                    title: 'éxito',
                    text: 'Procesando el envio del mensaje. Por favor espere.',
                    type: 'success',
                    timer: 2000
                });
            ...
            .done(function (response) {
                ...
                if (result == 1) {
                    ...
                    swal({
                        title: 'éxito',
                        text: 'Se ha agreado el seguimiento del candidato',
                        type: 'success',
                        timer: 2000
                    });
    ...
    function mostrarSeguimiento() {
        ...
        tablaUsuarios = $('#tablaUsuarios').DataTable({
            ...
            "ajax": {
                ...
                "data": {
                    usuario: "<?php echo $_GET['id'] ?>", empresa: "<?php echo $IDEmpresa?>"
