            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    ...
                    <h2 class="h4 font-w400  invisible" id="titulos" style="color: white;" data-toggle="appear"
                        data-class="animated fadeInUp">crea el perfil de tu empresa</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-7">
                ...
                <div class="block block-rounded block-themed">
                    ...
                    <div class="block-content block-content-full">
                        <p> <?php echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?>: <b style="color:#0B3486;">Completa
                                el formulario </b> ya que es requesito para tener acceso a la plataforma. <br> <b
                                    style="color:#0B3486;"> IMPORTANTE: Los campos con asterisco (*) son
                                obligatorios </b> y deben ser completados para continuar con el proceso de registro.</p>


                        <div class="form-group row">
                            <label class="col-12" for="example-select4">Área de la
                                empresa* <?php if ($resultPerfil == 1) {
                                    echo "Si desea cambiar el departamento debe seleccionar el pais de origen";
                                } ?></label>
                            <div class="col-12" id="areaempresa">
                                <!-- Select2 (.js-select2 class is initialized in Helpers.select2()) -->
                                <!-- For more info and examples you can check out https://github.com/select2/select2 -->
                                <select class="js-select2 form-control" id="example-select4" name="areaempresa"
                        ...
                        <div class="form-group row">
                            <label class="col-12" for="example-select2">Seleccione su país de
                                origen* <?php if ($resultPerfil == 1) {
                                    echo "Si desea cambiar el departamento debe seleccionar el pais de origen";
                                } ?></label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" name="razonsocial" id="razonsocial" required
                                       placeholder="Por favor, digite la razón social">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" name="ubicacionEmpresa" id="ubicacionEmpresa"
                                       placeholder="Por favor, digite la dirección de la empresa">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="js-ckeditor" name="DescriptionEmpresa"
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" name="emailEmpresa" id="emailEmpresa" required
                                       placeholder="Por favor, ingrese E-mail de la empresa">
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-left: 2px;">
                            ...
                            <input type="text" class="form-control" name="Facebook" id="Facebook"
                                   placeholder="https://www.facebook.com/tu_empresa">
                            <label class="col-12">Instagram </label>
                            <input type="text" class="form-control" name="Instagram" id="Instagram"
                                   placeholder="https://www.instagram.com/tu_empresa/">
                            <label class="col-12">Youtube </label>
                            <input type="text" class="form-control" name="youtube" id="youtube"
                                   placeholder="https://www.youtube.com/channel/tu_empresa">
                        ...
                        <div class="form-group row">
                            <label class="col-12">Activar Confidencial*
                                <a href="#" data-toggle='modal' data-target='#exampleModal2' class='js-tooltip-enabled'
                                   data-toggle='tooltip' title='' data-original-title='eliminar'>¿Qué significa
                                    esto?</a>
                            </label>
                            <div class="col-12">

                                <label class="css-control css-control-primary css-radio">
                                    <input type="radio" class="css-control-input" id="confidencial1" value="Si"
                                           name="confidencial" required>
                                    <span class="css-control-indicator"></span> Si
                                </label>
                                <label class="css-control css-control-secondary css-radio">
                                    <input type="radio" class="css-control-input" id="confidencial2" value="No"
                                           name="confidencial" required>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Los candidatos no podran revisar tu perfil de empresa si tiene activado Confidencial. Caso contrario
                    ,se muestra los siguientes datos</p>
                <ul>
                    <li>Pais & Ciudad</li>
                ...
                <p>Si tiene activado Confidencial cuando publique una oferta de trabajo tu nombre y logo de empresa no
                    aparece.</p>
...
<!--                                        Completa el formulario que se te muestra a continuación ya que es requesito para-->
<!--                                        tener acceso a las herramientas que brinda la plataforma.</P>-->
<!---->
<!---->
<!--                                    <ul style="text-align: left; " data-toggle="appear" data-class="animated fadeInUp">-->
<!--                                        <li>1 – Llena los datos de tu empresa <b style="color: red;">(Obligatorio)</b>.-->
<!--                                        </li>-->
<!--                                        <br>-->
<!--                                        <li>2 - Una vez completado los datos tu empresa se le notificará a soporte-->
<!--                                            técnico para contactarte y darte una orientación.-->
<!--                                        </li>-->
<!--                                        <br>-->
<!--                                        <li>3 – Solo tendrá 10 días hábiles para usar la plataforma.</li>-->
<!--                                        <br>-->
<!--                                        <li>4 – Una vez terminado su periodo de prueba. Deberá solicitar el servicio de-->
<!--                                            BOLSA LABORAL Centroamérica-->
<!--                                        </li>-->
<!--                                        <br>-->
<!--                                    </ul>-->
<!---->
...
<!--                                        --><?php //echo $PrimerNombre[0] . " " . $PrimerApellido[0]; ?><!--: Cualquier tipo de-->
<!--                                        información que esté relacionada con tus datos personales no será compartida ni-->
    ...
    $('#registroFinalizado').on('click', function () {
        ...
        if (AreaSelecionada == "") {
            ...
            $.ajax({
                ...
                dataType: 'html',
                data: {
                    usuario: "<?php echo $IDUser; ?>",
                    areaEmpresa: AreaSelecionada,
                    Pais: PaisSelecciona,
                    ...
                    nombre: "<?php echo $PrimerNombre[0]; ?>",
                    apellido: "<?php echo $PrimerApellido[0]; ?>",
