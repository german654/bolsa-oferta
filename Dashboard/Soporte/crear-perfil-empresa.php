            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-40 pb-20">
                    ...
                    <h2 class="h4 font-w400  invisible" id="titulos" style="color: white;" data-toggle="appear"
                        data-class="animated fadeInUp">Crea el Perfil empresa <?php echo $PrimerNombre[0] ?> ! </h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Los candidatos no podran revisar tu perfil de empresa si tiene activado Confidencial. Caso lo
                    contrario se muestra los siguientes datos</p>
                <ul>
                    <li>Pais & Ciudad</li>
