...
try {
	          ...
	          $mail->setFrom('danielm@mundoempleosca.com', 'Equipo de BOLSA LABORAL CA');
			    ...
			    $mail->Subject = 'Bienvenido a BOLSA LABORAL | Activa tu cuenta '.$Nombres.'';
