...
<!--                                         style="height: 100px; width: 250px;">-->
                                    ...
                                    <p class="text-muted" style="text-align: justify;">
                                        ...
                                        publicada en esta plataforma. Tus datos personales solo seran mostradas con los
                                        administradores de BOLSA LABORAL.
                                        <br><br>
                                        Si desea leer más información puedes leer Póliticas de la plataforma.
                                    </p>

                                    <p style="text-align: justify;">Al finalizar fecha <?php echo $FechaVencimiento ?>
                                        Ya no podra utilizar la plataforma por que deberas solicitar el servicio de
                                        BOLSA LABORAL.<br></p>


                                    <a href="#" class="btn btn-sm btn-hero btn-noborder  mb-10 mx-5"
                                       style="background:#FCC201; color:#0B3486; font-weight: bold;"> Ir <i
