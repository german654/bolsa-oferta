...
class EnviarCorreos 
{
	...
	public function EnviarVerfificacion($Nombre, $emial , $Token){
		...
		try {
			    ...
			    $mail->Subject = 'Bienvenido a BOLSA LABORAL | Activa tu cuenta '.$Nombre.'';
